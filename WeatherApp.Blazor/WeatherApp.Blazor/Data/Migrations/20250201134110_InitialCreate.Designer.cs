...
namespace WeatherApp.Blazor.Migrations
{
    ...
    [Migration("20250201134110_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeatherApp.Blazor.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WeatherApp.Blazor.Models.ForecastDayBlazor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WeatherApp.Blazor.Models.ForecastHourBlazor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WeatherApp.Blazor.Models.WeatherCurrentBlazor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WeatherApp.Blazor.Models.WeatherForecastBlazor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WeatherApp.Shared.Models.Entities.Astro", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WeatherApp.Shared.Models.Entities.Condition", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WeatherApp.Shared.Models.Entities.Current", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WeatherApp.Shared.Models.Entities.Location", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WeatherApp.Shared.Models.Entities.Management.SyncRequestInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WeatherApp.Blazor.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WeatherApp.Blazor.Models.ForecastDayBlazor", b =>
                {
                    b.HasOne("WeatherApp.Shared.Models.Entities.Astro", "Astro")
                        .WithMany()
                        .HasForeignKey("AstroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WeatherApp.Shared.Models.Entities.Condition", "Condition")
                        .WithMany()
                        .HasForeignKey("ConditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WeatherApp.Blazor.Models.WeatherForecastBlazor", "WeatherForecast")
            ...
            modelBuilder.Entity("WeatherApp.Blazor.Models.ForecastHourBlazor", b =>
                {
                    ...
                    b.HasOne("WeatherApp.Blazor.Models.ForecastDayBlazor", "ForecastDay")
            ...
            modelBuilder.Entity("WeatherApp.Blazor.Models.WeatherCurrentBlazor", b =>
                {
                    b.HasOne("WeatherApp.Blazor.Data.ApplicationUser", "Account")
                        .WithMany()
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("WeatherApp.Shared.Models.Entities.Current", "Current")
                        .WithOne()
                        .HasForeignKey("WeatherApp.Blazor.Models.WeatherCurrentBlazor", "CurrentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("WeatherApp.Shared.Models.Entities.Location", "Location")
                        .WithOne()
                        .HasForeignKey("WeatherApp.Blazor.Models.WeatherCurrentBlazor", "LocationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("WeatherApp.Blazor.Models.WeatherForecastBlazor", b =>
                {
                    ...
                    b.HasOne("WeatherApp.Shared.Models.Entities.Current", "Current")
                        .WithOne()
                        .HasForeignKey("WeatherApp.Blazor.Models.WeatherForecastBlazor", "CurrentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("WeatherApp.Shared.Models.Entities.Location", "Location")
                        .WithOne()
                        .HasForeignKey("WeatherApp.Blazor.Models.WeatherForecastBlazor", "LocationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("WeatherApp.Shared.Models.Entities.Current", b =>
                {
                    b.HasOne("WeatherApp.Shared.Models.Entities.Condition", "Condition")
                        .WithOne()
                        .HasForeignKey("WeatherApp.Shared.Models.Entities.Current", "ConditionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
