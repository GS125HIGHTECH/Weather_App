...
{
    public class ForecastDayBlazor : EntityBase<long>
    {
        public long WeatherForecastId { get; set; }
        public virtual WeatherForecastBlazor? WeatherForecast { get; set; }
        ...
        public virtual ICollection<ForecastHourBlazor>? ForecastHours { get; set; }
    }
}